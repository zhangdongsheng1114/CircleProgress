...
/**
 * Created by tarena on 2017/7/15.
 */

public class CircleProgress extends View {

    private int mCurrent;  // 当前精度
    ...
    // 暴露回掉方法
    public void setOnLoadingComleteListener(OnLoadingCompleteListener loadingComleteListener) {
        this.mLoadingCompleteListener = loadingComleteListener;
    }
